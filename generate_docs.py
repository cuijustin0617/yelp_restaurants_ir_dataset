...
for review in reviews:
    ...
    if business_id in restaurant_names and review_counts[business_id] < 50:
        ...
        safe_filename = "docs_70/" + restaurant_name.replace('/', '_').replace(chr(92), '_') + ".txt"
